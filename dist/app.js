...
const core_1 = require("fusioncharts/core");
const column2d_1 = require("fusioncharts/viz/column2d");
const generator_1 = require("./generator");
core_1.default.addDep(column2d_1.default);
var generator = new generator_1.default();
var data = generator.generate({
    dataCount: 12
}).getData();
const isReady = () => {
    var chartInstance = new core_1.default({
...
core_1.default.ready(isReady);

});
___scope___.file("generator.js", function(exports, require, module, __filename, __dirname){
...
class Generator {
    ...
    generate(config = {}) {
        let generator = this, i, j, dataObj, dsCount = utils_1.pluckNumber(config.dsCount), dataCount = utils_1.pluckNumber(config.dataCount, 1), dataSource = generator.dataSource;
        if (utils_1.defined(dsCount)) {
            dataSource.dataset = [];
            for (i = 0; i < dsCount; i++) {
                dataObj = {
                    data: []
                ...
                for (j = 0; j < dataCount; j++) {
                    dataObj.data.push(utils_1.createData(i));
                }
            ...
            for (i = 0; i < dataCount; i++) {
                dataSource.data.push(utils_1.createData(i));
            }
        }
        dataSource.chart = {
            'caption': 'Monthly',
    ...
    getData() {
        return utils_1.getObjectCopy(this.dataSource);
    }
}
...
return ___scope___.entry = "src/renderer.js";
});

FuseBox.import("fc-npm-tester/renderer.js");
FuseBox.main("fc-npm-tester/renderer.js");
FuseBox.defaultPackageName = "fc-npm-tester";
})
